...
INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_theme', '1', 'prop', 'varchar', 'prop', '0', 'N', '50', 'Y' );

INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_theme', '2', 'value', 'varchar', 'value', '0', 'Y', '500', 'N' );

INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_theme', '3', 'userid', 'varchar', 'userid', '0', 'Y', '50', 'N' );
...
CREATE TABLE `dw_custom_column` (
  ...
  PRIMARY KEY (`table_id`,`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_custom_column', '1', 'table_id', 'varchar', 'table_id', '0', 'N', '50', 'Y' );

INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_custom_column', '2', 'userid', 'varchar', 'userid', '0', 'N', '50', 'Y' );

INSERT INTO `dw_rdbms_fields` ( `TABLE_NAME`, `SEQ`, `FIELD_NAME`, `FIELD_TYPE`, `FIELD_DISPLAY_NAME`, `SCALE`, `NULLABLE`, `SIZE`, `IS_KEY` ) VALUES ( 'dw_custom_column', '3', 'config', 'varchar', 'config', '0', 'Y', '500', 'N' );
